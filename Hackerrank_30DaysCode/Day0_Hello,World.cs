...
{
    internal class Day0_Hello_World
    {
        static void Main(String[] args)
        {

            Console.WriteLine("Enter the string ::");
            //a Scanner object  to read input from stdin
            string inputString = Console.ReadLine();


            //it the conversion is not completed with string type data

            int result;

            if (int.TryParse(inputString, out result))
            {
                // Successful conversion, proceed with result
            ...
            //a string literal saying "Hello, World.
            Console.WriteLine("Hello, World.");

            //the contents of inputString to stdout
